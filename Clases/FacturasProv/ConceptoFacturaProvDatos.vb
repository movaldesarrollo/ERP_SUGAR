Public Class DatosConceptoFacturaProv
    ...
    Private idconceptoAlbaranProv As Long
    ...
    Public Property gidconceptoAlbaranProv() As Long
        Get
            Return idconceptoAlbaranProv
        End Get
        Set(ByVal value As Long)
            idconceptoAlbaranProv = value
        End Set
    End Property
    ...
    'Public Property gnumAlbaranProv() As String
    '    Get
    '        Return numAlbaranProv
    '    End Get
    '    Set(ByVal value As String)
    '        numAlbaranProv = value
    '    End Set
    'End Property
