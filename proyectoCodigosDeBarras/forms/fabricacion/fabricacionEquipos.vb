...
Public Class fabricacionEquipos
...
#Region "FUNCIONES Y PROCEDIMIENTOS"
    ...
    Public Sub llenarlv()
        ...
        cargaCompleta = funcCB.llenarLvEquipos(lvEquipos, dtpFecha.Value, If(IsNumeric(cbEquipos.SelectedValue), cbEquipos.SelectedValue, 0))
    ...
    Public Sub cargarComboArticulos()
        ...
        funcCB.buscarEquipos(cbEquipos)
