...
Public Class EtiquetaFinalLine
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_SUGAR.EtiquetaFinalLine.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEtiquetaFinalLine
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EtiquetaFinalLine = New EtiquetaFinalLine()
        rpt.Site = Me.Site
        Return rpt
    End Function
