...
Public Class EtiquetaEquipoCB
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_SUGAR.EtiquetaEquipoCB.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEtiquetaEquipoCB
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EtiquetaEquipoCB = New EtiquetaEquipoCB()
        rpt.Site = Me.Site
        Return rpt
    End Function
