...
Public Class EtiquetaEquipoAU1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_SUGAR.EtiquetaEquipoAU1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEtiquetaEquipoAU1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EtiquetaEquipoAU1 = New EtiquetaEquipoAU1()
        rpt.Site = Me.Site
        Return rpt
    End Function
