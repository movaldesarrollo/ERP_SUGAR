...
Public Class EtiquetaEquipo_old
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_SUGAR.EtiquetaEquipo_old.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEtiquetaEquipo_old
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EtiquetaEquipo_old = New EtiquetaEquipo_old()
        rpt.Site = Me.Site
        Return rpt
    End Function
