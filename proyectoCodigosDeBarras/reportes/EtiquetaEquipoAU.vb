...
Public Class EtiquetaEquipoAU
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_SUGAR.EtiquetaEquipoAU.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEtiquetaEquipoAU
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EtiquetaEquipoAU = New EtiquetaEquipoAU()
        rpt.Site = Me.Site
        Return rpt
    End Function
