...
Public Class EtiquetaCelulaCB
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_SUGAR.EtiquetaCelulaCB.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEtiquetaCelulaCB
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EtiquetaCelulaCB = New EtiquetaCelulaCB()
        rpt.Site = Me.Site
        Return rpt
    End Function
