...
Public Class logReparaciones
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_SUGAR.logReparaciones.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedlogReparaciones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As logReparaciones = New logReparaciones()
        rpt.Site = Me.Site
        Return rpt
    End Function
