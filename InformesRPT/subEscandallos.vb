...
Public Class subEscandallos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_SUGAR.subEscandallos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedsubEscandallos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As subEscandallos = New subEscandallos()
        rpt.Site = Me.Site
        Return rpt
    End Function
