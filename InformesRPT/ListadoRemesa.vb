...
Public Class ListadoRemesa
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_SUGAR.ListadoRemesa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedListadoRemesa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ListadoRemesa = New ListadoRemesa()
        rpt.Site = Me.Site
        Return rpt
    End Function
