...
Public Class ListadoEstadisticaProduccion
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ListadoEstadisticaProduccion.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_SUGAR.ListadoEstadisticaProduccion.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_sBusqueda() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedListadoEstadisticaProduccion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ListadoEstadisticaProduccion = New ListadoEstadisticaProduccion()
        rpt.Site = Me.Site
        Return rpt
    End Function
