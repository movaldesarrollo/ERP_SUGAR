...
Public Class ListadoStockFecha
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_SUGAR.ListadoStockFecha.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedListadoStockFecha
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ListadoStockFecha = New ListadoStockFecha()
        rpt.Site = Me.Site
        Return rpt
    End Function
