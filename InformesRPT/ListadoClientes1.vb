...
Public Class ListadoClientes1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_SUGAR.ListadoClientes1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedListadoClientes1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ListadoClientes1 = New ListadoClientes1()
        rpt.Site = Me.Site
        Return rpt
    End Function
