...
Public Class EscandallosMateriasPrimas
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "EscandallosMateriasPrimas.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_SUGAR.EscandallosMateriasPrimas.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_verCostes() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_tituloInforme() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedEscandallosMateriasPrimas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EscandallosMateriasPrimas = New EscandallosMateriasPrimas()
        rpt.Site = Me.Site
        Return rpt
    End Function
