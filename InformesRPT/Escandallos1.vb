...
Public Class Escandallos1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_SUGAR.Escandallos1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IDSescandallo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedEscandallos1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Escandallos1 = New Escandallos1()
        rpt.Site = Me.Site
        Return rpt
    End Function
