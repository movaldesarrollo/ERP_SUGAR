...
Public Class EtiquetaEstastes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_SUGAR.EtiquetaEstastes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEtiquetaEstastes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EtiquetaEstastes = New EtiquetaEstastes()
        rpt.Site = Me.Site
        Return rpt
    End Function
