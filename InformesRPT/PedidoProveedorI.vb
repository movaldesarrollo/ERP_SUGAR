...
Public Class PedidoProveedorI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_SUGAR.PedidoProveedorI.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_cantidadParcial() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedPedidoProveedorI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PedidoProveedorI = New PedidoProveedorI()
        rpt.Site = Me.Site
        Return rpt
    End Function
