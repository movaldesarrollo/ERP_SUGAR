...
Public Class subsubVencimientos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_SUGAR.subsubVencimientos.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_numfactura() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedsubsubVencimientos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As subsubVencimientos = New subsubVencimientos()
        rpt.Site = Me.Site
        Return rpt
    End Function
