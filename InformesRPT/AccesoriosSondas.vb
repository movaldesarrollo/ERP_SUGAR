...
Public Class AccesoriosSondas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_SUGAR.AccesoriosSondas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAccesoriosSondas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AccesoriosSondas = New AccesoriosSondas()
        rpt.Site = Me.Site
        Return rpt
    End Function
