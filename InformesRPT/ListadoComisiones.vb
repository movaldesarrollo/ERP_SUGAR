...
Public Class ListadoComisiones
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_SUGAR.ListadoComisiones.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedListadoComisiones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ListadoComisiones = New ListadoComisiones()
        rpt.Site = Me.Site
        Return rpt
    End Function
