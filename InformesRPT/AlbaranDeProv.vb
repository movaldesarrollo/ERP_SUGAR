...
Public Class AlbaranDeProv
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_SUGAR.AlbaranDeProv.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAlbaranDeProv
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AlbaranDeProv = New AlbaranDeProv()
        rpt.Site = Me.Site
        Return rpt
    End Function
