...
Public Class EtiquetasPlaca
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_SUGAR.EtiquetasPlaca.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEtiquetasPlaca
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EtiquetasPlaca = New EtiquetasPlaca()
        rpt.Site = Me.Site
        Return rpt
    End Function
