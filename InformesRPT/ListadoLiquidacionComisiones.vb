...
Public Class ListadoLiquidacionComisiones
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ListadoLiquidacionComisiones.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_SUGAR.ListadoLiquidacionComisiones.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_TotalBaseEU() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_iidLiquidacion() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedListadoLiquidacionComisiones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ListadoLiquidacionComisiones = New ListadoLiquidacionComisiones()
        rpt.Site = Me.Site
        Return rpt
    End Function
