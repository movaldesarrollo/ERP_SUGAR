...
Public Class PedidoProveedor2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_SUGAR.PedidoProveedor2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_soloparcial() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedPedidoProveedor2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PedidoProveedor2 = New PedidoProveedor2()
        rpt.Site = Me.Site
        Return rpt
    End Function
