...
Public Class EstadisticaVentas2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_SUGAR.EstadisticaVentas2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEstadisticaVentas2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EstadisticaVentas2 = New EstadisticaVentas2()
        rpt.Site = Me.Site
        Return rpt
    End Function
