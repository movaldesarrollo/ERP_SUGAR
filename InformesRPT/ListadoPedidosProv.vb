...
Public Class ListadoPedidosProv
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_SUGAR.ListadoPedidosProv.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedListadoPedidosProv
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ListadoPedidosProv = New ListadoPedidosProv()
        rpt.Site = Me.Site
        Return rpt
    End Function
