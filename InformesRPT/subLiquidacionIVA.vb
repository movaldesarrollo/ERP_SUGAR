...
Public Class subLiquidacionIVA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_SUGAR.subLiquidacionIVA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedsubLiquidacionIVA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As subLiquidacionIVA = New subLiquidacionIVA()
        rpt.Site = Me.Site
        Return rpt
    End Function
