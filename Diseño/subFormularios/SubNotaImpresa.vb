Public Class SubNotaImpresa
    ...
    Private NotaOriginal As String
    ...
    Public Property pNota() As String
        ...
        End Set
    End Property
    Private Sub SubNotaImpresa_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing

        If NotaOriginal = rtbNota.Rtf Then
            e.Cancel = False
        Else
            If MsgBox("¿Salir sin guardar los cambios?", MsgBoxStyle.OkCancel) = MsgBoxResult.Ok Then
                rtbNota.Rtf = NotaOriginal
                e.Cancel = False
            Else
                e.Cancel = True
            End If
    ...
    Private Sub SubNotaImpresa_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        rtbNota.Rtf = NotaOriginal
