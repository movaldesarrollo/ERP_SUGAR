...
Public Class InformeReparacion
    ...
    Private Sub CRV_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CRV.Load
        Copias.Text = 1
    End Sub
    Public Function verInforme(ByVal inumReparacion As Integer, ByVal idIdioma As Integer, ByVal codigo As String) As Boolean
        ...
        Try
            ...
            If idIdioma = 1 Then
                informe = New HojaReparacion1
                informe.SetDatabaseLogon(csb.UserID, csb.Password)
                informe.SetParameterValue("inumReparacion", inumReparacion)
                informe.SetParameterValue("codigoEquipo", codigo)
    ...
    Public Function GeneraPDF(ByVal inumReparacion As Integer, ByVal idIdioma As Integer, ByVal Fichero As String, ByVal Camino As String, ByVal codigo As String) As Boolean
