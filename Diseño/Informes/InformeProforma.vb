...
Public Class InformeProforma
    ...
    Private Sub CRV_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CRV.Load
        Copias.Text = 1
    End Sub
    Public Function verInforme(ByVal inumProforma As Integer, ByVal idIdioma As Integer) As Boolean
        ...
        If idIdioma = 1 Then
            informe = New Proforma1
            informe.SetDatabaseLogon(csb.UserID, csb.Password)
            informe.SetParameterValue("inumProforma", inumProforma)
            CRV.ReportSource = informe
        Else
            informe = New Proforma1I
            informe.SetDatabaseLogon(csb.UserID, csb.Password)
            informe.SetParameterValue("inumProforma", inumProforma)
            CRV.ReportSource = informe
        End If
    ...
    Public Function GeneraPDF(ByVal inumProforma As Integer, ByVal idIdioma As Integer, ByVal Fichero As String, ByVal Camino As String) As Boolean
