...
Public Class InformeOferta
    ...
    Private Sub CRV_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CRV.Load
        Copias.Text = 1
    End Sub
    Public Function verInforme(ByVal inumOferta As Integer, ByVal idIdioma As Integer) As Boolean
        ...
        If idIdioma = 1 Then
            ...
            informe.SetParameterValue("inumOferta", inumOferta)
            CRV.ReportSource = informe
        Else
            informe = New Oferta1I
            informe.SetDatabaseLogon(csb.UserID, csb.Password)
            informe.SetParameterValue("inumOferta", inumOferta)
            CRV.ReportSource = informe
        End If
    ...
    Public Function GeneraPDF(ByVal inumOferta As Integer, ByVal idIdioma As Integer, ByVal Fichero As String, ByVal Camino As String) As Boolean
