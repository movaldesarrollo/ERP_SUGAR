...
Public Class InformeListadoProveedores
    ...
    Public Function verInforme(ByVal sBusqueda As String, ByVal sOrden As String) As Boolean
        ...
        Dim informe As New ListadoProveedores
        ...
        informe.SetParameterValue("sParametro", sBusqueda & If(sOrden = "", " ORDER By NombreComercial ", " ORDER BY " & sOrden))
