...
Public Class InformeListadoProformas
    ...
    Public Function verInforme(ByVal sBusqueda As String, ByVal sOrden As String, ByVal TotalEU As Double) As Boolean
        ...
        Dim informe As Object = New ListadoProformas
        ...
        sBusqueda = sBusqueda & If(sOrden = "", " ORDER BY DOC.numProforma DESC ", " Order BY " & sOrden)
