...
Public Class InformeListadoProduccion
    ...
    Public Function verInforme(ByVal sBusqueda As String, ByVal sOrden As String) As Boolean
        ...
        Dim informe As New ListadoProduccionDetalle
        ...
        informe.SetParameterValue("sParametro", If(sBusqueda = "", "", " WHERE " & sBusqueda) & If(sOrden = "", " Order By idProduccion ", " ORDER BY " & sOrden))
    ...
    Public Function verInformeGlobal(ByVal dt As DataTable) As Boolean

        Dim informe As New ListadoProduccionGlobal
