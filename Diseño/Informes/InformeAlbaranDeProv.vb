...
Public Class InformeAlbaranDeProv
    ...
    Public Function verInforme(ByVal iidAlbaran As Integer) As Boolean
        ...
        informe = New AlbaranDeProv
        informe.SetDatabaseLogon(csb.UserID, csb.Password)
        informe.SetParameterValue("iidAlbaran", iidAlbaran)
        CRV.ReportSource = informe
        Return True

    End Function

    Public Function GeneraPDF(ByVal iidAlbaran As Integer, ByVal Fichero As String, ByVal Camino As String) As Boolean
