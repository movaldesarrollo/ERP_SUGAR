Public Class GestionClientes_old
...
#Region "FACTURACION"
    ...
    Private Sub bMenosBancos_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bMenosBancos.Click
        If indiceB > -1 Then
            If MsgBox("¿Eliminar la cuenta seleccionada de la lista?", MsgBoxStyle.OkCancel) Then
                If funcCB.EnUso(lvBancos.Items(indiceB).Text, iidCliente) Then
                    MsgBox("No se puede eliminar la cuenta porque está en uso en alguna factura. Alternativamente se puede inactivar.")
                Else
...
#End Region
    ...
    Private Sub bVerNota_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bVerNota.Click
        Dim ggnotaimpresa As New SubNotaImpresa
        ggnotaimpresa.pNota = rtbNota.Rtf
        ggnotaimpresa.ShowDialog()

        If ggnotaimpresa.DialogResult = Windows.Forms.DialogResult.OK Then
            rtbNota.Rtf = ggnotaimpresa.pNota
            CambiosFacturacion = True
        End If
    End Sub
End Class