...
Public Class GestionPedidoProveedor
...
#Region "VARIABLES"
    ...
    Public iidProveedor As Integer
    ...
    Private funVerParciales As New FuncionesConceptosPedidosProv
...
#Region "PROPIEDADES"
    ...
    Property pNumPedido() As Integer
        ...
        End Set
    End Property
    Property pPedidoPendiente() As Boolean
        Get
            Return rbPedidoPendiente.Checked
        End Get
        Set(ByVal value As Boolean)
            rbPedidoPendiente.Checked = value
        End Set
    End Property
...
#Region "INICIALIZACIÓN"
    ...
    'introduce los transportes y portes.
    ...
    Private Sub inicializaConcepto() 'TIEMPO PAUSA---------------------------------------------------------------------xxxxxxxxxxxxxxxxxxxxxxxx
...
#Region "PROCEDIMIENTOS Y FUNCIONES"
    ...
    Private Sub lvConceptosNuevaLinea(ByVal dts As DatosConceptoPedidoProv)
        ...
        With lvConceptos.Items.Add(dts.gidConcepto)
            ...
            .SubItems.Add(FormatNumber(dts.gPendiente, 2) & dts.gTipoUnidad)
            'If rbPedidoCompleto.Checked = True Then
    ...
    Private Function cargaConcepto() As DatosConceptoPedidoProv
        ...
        Else
            ...
            dts.gSeccion = cbSeccion.SelectedItem.gSeccion
        End If
        Return dts
        ...
        If cbNombre.Text <> "" And Cantidad.Text <> "" Then   'solo actua si hay alguna información en la zona de edición
            ...
            Try
                ...
                If lvIndice = -1 Then
                    ...
                    dts = funcCP.mostrar1(dts.gidConcepto)
                    lvConceptosNuevaLinea(dts)
    ...
    Private Sub ActualizarLineaLV(ByVal dts As DatosConceptoPedidoProv)
        With lvConceptos.Items(lvIndice)
            ...
            .SubItems(12).Text = FormatNumber(dts.gPendiente, 2) & dts.gTipoUnidad
...
#Region "BOTONES GENERALES"
    ...
    Private Sub bGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bGuardar.Click
        ...
        If validar Then
            ...
            dtsPP.gidTipoIVA = dtsFA.gidTipoIVA 'cbTipoIVA.SelectedItem.gidTipoIVA
            dtsPP.gTipoIVAFac = dtsFA.gTipoIVA 'cbTipoIVA.SelectedItem.gtipoIVA
            dtsPP.gTipoIVA = dtsFA.gTipoIVA 'cbTipoIVA.SelectedItem.gtipoIVA
    ...
    Private Sub bImprimir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bImprimir.Click
        ...
        Else
            InformePedidoProv.verInforme(numPedido.Text, rbPedidoPendiente.Checked, funcUB.campoIdioma(iidUbicacion))
    ...
    Private Sub bEmail_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bEmail.Click
        ...
        Else
            ...
            InformePedidoProv.GeneraPDF(numPedido.Text, funcUB.campoIdioma(iidUbicacion), rbPedidoPendiente.Checked, fichero, camino)
    ...
    Private Sub bRecepcion_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bRecepcion.Click
        ...
        If validar Then
            ...
            Dim conceptosString As String = ""

            If lvConceptos.CheckedItems.Count > 0 Then

                Dim conceptos As New List(Of Integer)

                For Each item In lvConceptos.CheckedItems

                    conceptos.Add(item.text)
                ...
                GG.pnumHasta = 0
                GG.ListaConceptosPedidosProv = conceptos
                GG.ShowDialog()
                Semaforo = True
                CargarDatosConceptos(numPedido.Text)
            Else

                MsgBox("Seleccione los conceptos a recepcionar.", MsgBoxStyle.Information)
    ...
    Private Sub bPDF_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bPDF.Click
        ...
        Else
            ...
            sfd.ShowDialog()
            InformePedidoProv.GeneraPDF(numPedido.Text, funcUB.campoIdioma(iidUbicacion), rbPedidoPendiente.Checked, sfd.FileName, "")
...
#Region "EVENTOS"
    ...
    Private Sub lvConceptos_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lvConceptos.DoubleClick
        ...
        If lvConceptos.SelectedItems.Count > 0 Then
            ...
            Try
                ...
                DescuentoC.Text = FormatNumber(dts.gDescuento, 2)
                cbSeccion.Text = dts.gSeccion
    ...
    HorarioEntrega.TextChanged, cbTipoIVA.SelectedIndexChanged, cbsolicitadoVia.SelectedIndexChanged, cbSolicitadoPor.SelectedIndexChanged, PrecioTransporte.TextChanged, _
     ckPagado.CheckedChanged, cbContacto.SelectedIndexChanged, cbValorado.SelectedIndexChanged, Nota.TextChanged, Descuento.TextChanged, cbTransporte.SelectedIndexChanged, cbSeccion.SelectedIndexChanged
        cambios = Semaforo
    End Sub
    ...
    Private Sub dtpFechaEntrega_valueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles dtpFechaEntrega.ValueChanged
        If Semaforo Then
            'dtpFechaPrevistaC.Value = dtpFechaEntrega.Value
            cambios = Semaforo
            If dtsPP Is Nothing AndAlso G_AGeneral = "A" AndAlso dtsPP.gFechaEntrega.Date <> dtpFechaEntrega.Value.Date Then
                Call PropagarCambioFechaEntrega()
            End If

        End If
    End Sub

    Private Sub PropagarCambioFechaEntrega()
        If MsgBox("¿Desea propagar la nueva fecha de entrega a todas las lineas del pedido?", MsgBoxStyle.OkCancel) = MsgBoxResult.Ok Then
            funcCP.PropagarFechaEntrega(numPedido.Text, dtpFechaEntrega.Value.Date)
            cambios = True
        End If
    End Sub
...
#End Region
    ...
    'Al seleccionar completo o parcial se recarga el listview con los articulos, si la cantidad recibida es inferior a la demandada solo se muestran los parciales si no cargará todos.
    Public Sub rbPedidoPendiente_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rbPedidoCompleto.CheckedChanged
        Dim contador As Double = 0
        If numPedido.Text <> "" Then
            vnumpedido = numPedido.Text
            If rbPedidoPendiente.Checked = True Then
                Dim lista As List(Of DatosConceptoPedidoProv) = funVerParciales.mostrarparcial(vnumpedido, True)
                Dim dts As DatosConceptoPedidoProv
                lvConceptos.Items.Clear()
                For Each dts In lista
                    lvConceptosNuevaLinea(dts)
    ...
    Private Sub ALBARANToolStripMenuItem_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ALBARANToolStripMenuItem.Click

        If lvConceptos.Items.Count > 0 Then

            For Each item In lvConceptos.SelectedItems

                Dim gg As New verAlbaranesDeConceptosPedidosProv

                gg.idconcepto = item.text
    ...
    Private Sub ckTodos_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ckTodos.Click
        'Si marcamos el check arriba, se propaga a todas las lineas. Si es indetermianado no hacemos nada
        If ckTodos.CheckState = CheckState.Indeterminate Then
        Else
            Semaforo = False
            For Each item As ListViewItem In lvConceptos.Items
