...
Public Class GestionFactura1
    ...
    Private Sub GestionFactura_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            'G_AGeneral = "A"
        End If
        'PrecioTransporte.Text = funcOF.transporteprecio(dtsOF.gnumFactura)    ''****QUITADO POR RAUL 
        rtbNota.Rtf = funcOF.notasfactura(dtsOF.gnumFactura)
        semaforo = True
...
#Region "PROCEDIMIENTOS Y FUNCIONES"
        ...
        Try
            ...
            If validar Then
                ...
                Else
                    ...
                    'funcOF.actualizarVencimientos(dtsOF)   ****RAUL
                    'Call CargarlvVencimientos(dtsOF.gVencimientos) ' *******LUIS
    ...
    Public Sub CargarlvVencimientos(ByVal Vtos As List(Of DatosVencimiento))
        lvVencimientos.Items.Clear()
        Dim Cobrados As Integer = 0
        Dim Devueltos As Integer = 0
        'Dim funcVE As New FuncionesVencimientos
        Vtos = funcVE.Mostrar(numDoc.Text)
    ...
    Private Sub bVencimientos_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bVencimientos.Click
        If G_AGeneral = "A" Then
            ...
            Select Case cbEstado.Text
                Case "COBRADA"
                    funcOF.cambiarEstado(pnumFactura)
                    dtsOF.gidEstado = 29
                    bGuardar.Enabled = False
                Case "PENDIENTE"
                    funcOF.cambiarEstadoPendiente(pnumFactura)
                    dtsOF.gidEstado = 27
                    bGuardar.Enabled = True
                Case "PARCIAL"
                    funcOF.cambiarEstadoParcial(pnumFactura)
                    dtsOF.gidEstado = 28
                    bGuardar.Enabled = False
                Case "DEVUELTA"
                    funcOF.cambiarEstadoDevuelta(pnumFactura)
                    dtsOF.gidEstado = 64
                    bGuardar.Enabled = True
            End Select
