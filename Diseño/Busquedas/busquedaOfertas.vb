Public Class busquedaOfertas
    ...
    Property pnumOferta() As Integer
        Get
            Return inumOferta
        End Get
...
#Region "PROCEDIMIENTOS Y FUNCIONES"
    ...
    Private Sub busqueda()
        ...
        If numDoc.Text <> "" Then
            ...
            sBusqueda = sBusqueda & " DOC.numOferta like '" & numDoc.Text & "%' "
        End If
        ...
        If cbCodArticulo.Text <> "" Then
            sBusqueda = sBusqueda & IIf(sBusqueda = "", "", " AND ")
            sBusqueda = sBusqueda & " DOC.numOferta in (select numOferta from ConceptosOfertas left join Articulos ON Articulos.idArticulo = ConceptosOfertas.idArticulo where codArticulo = '" & cbCodArticulo.Text & "') "
        ElseIf cbArticulo.SelectedIndex <> -1 Then
            sBusqueda = sBusqueda & IIf(sBusqueda = "", "", " AND ")
            sBusqueda = sBusqueda & " DOC.numOferta in (select numOferta from ConceptosOfertas where idArticulo = " & cbArticulo.SelectedItem.itemdata & ") "
        End If
    ...
    Private Sub ActualizarLV()
        Try
            ...
            Dim lista As List(Of DatosOferta) = funcOF.Busqueda(sBusqueda, Orden, True)
            For Each dts As DatosOferta In lista
                Ofertas.Add(dts.gnumOferta)
                With lvDocumentos.Items.Add(dts.gnumOferta)
    ...
    Private Sub ActualizarLineaLV()
        If indice <> -1 Then
            inumOferta = lvDocumentos.Items(indice).Text
            Dim dtsOF As DatosOferta = funcOF.Mostrar1(inumOferta)
...
#Region "EVENTOS"
    ...
    Private Sub numOferta_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    Private Sub lvDocumentos_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles lvDocumentos.DoubleClick
        If lvDocumentos.SelectedItems.Count > 0 Then
            ...
            If modo = "B" Then
                ...
                Me.Close()
            Else
                Dim GP As New GestionOferta
                GP.pnumOferta = lvDocumentos.SelectedItems(0).Text
    ...
    Private Sub nombrefiscal_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbResponsable.SelectedIndexChanged, cbEstado.SelectedIndexChanged, cbAño.TextChanged
