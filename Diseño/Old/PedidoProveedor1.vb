...
Public Class PedidoProveedor1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_SUGAR.PedidoProveedor1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPedidoProveedor1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PedidoProveedor1 = New PedidoProveedor1()
        rpt.Site = Me.Site
        Return rpt
    End Function
