...
Public Class PedidoProveedor1I
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ERP_SUGAR.PedidoProveedor1I.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPedidoProveedor1I
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PedidoProveedor1I = New PedidoProveedor1I()
        rpt.Site = Me.Site
        Return rpt
    End Function
